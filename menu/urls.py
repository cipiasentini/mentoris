...
urlpatterns = [
    ...
    path('editar/tutor/<int:dni>/', views.editarTutor, name='editar-tutor'),
    path('editar/tutor/baja/<int:dni>/', views.bajaTutor, name='baja-tutor'),
    path('editar/tutor/alta/<int:dni>/', views.altaTutor, name='alta-tutor'),
